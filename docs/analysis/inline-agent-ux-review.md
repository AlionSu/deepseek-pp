...
- 状态：P0 批次已完成并合入（PR [#542](https://github.com/zhu1090093659/deepseek-pp/pull/542)）；P1 批次实现中（GitHub Issue [#544](https://github.com/zhu1090093659/deepseek-pp/issues/544)，分支 `codex/handle-issue-544`）。
