...
- 状态：已立项。P0 批次已实现并通过完整验证链（分支 `codex/handle-issue-541`，PR [#542](https://github.com/zhu1090093659/deepseek-pp/pull/542)，GitHub Issue [#541](https://github.com/zhu1090093659/deepseek-pp/issues/541)）；P1 批次未开工。
