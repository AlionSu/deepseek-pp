export const content = {
  ...
  agent: {
    ...
    tools: '工具调用',
    results: '执行结果',
    running: 'Agent 运行中 · 第 {step} 步 · 已调用 {tools} 次工具 · 用时 {seconds} 秒',
    consoleComplete: 'Agent 完成 · {steps} 步 · {tools} 次工具 · 用时 {seconds} 秒',
    consolePaused: 'Agent 已暂停 · {steps} 步 · {tools} 次工具 · 用时 {seconds} 秒',
    consoleError: 'Agent 执行出错 · {steps} 步 · {tools} 次工具 · 用时 {seconds} 秒',
