export const content = {
  ...
  agent: {
    ...
    tools: 'Tool calls',
    results: 'Results',
    running: 'Agent running · step {step} · {tools} tool calls · {seconds}s',
    consoleComplete: 'Agent complete · {steps} steps · {tools} tool calls · {seconds}s',
    consolePaused: 'Agent paused · {steps} steps · {tools} tool calls · {seconds}s',
    consoleError: 'Agent error · {steps} steps · {tools} tool calls · {seconds}s',
